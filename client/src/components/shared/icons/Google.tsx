...
const SvgGoogle = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g clipPath="url(#google_svg__a)">
      <path
        d="M19.805 10.23c0-.68-.055-1.363-.172-2.032H10.2v3.851h5.402a4.628 4.628 0 0 1-2 3.039v2.499h3.223c1.893-1.742 2.98-4.314 2.98-7.357Z"
        fill="#4285F4"
      />
      <path
        d="M10.2 20c2.697 0 4.971-.885 6.629-2.413l-3.223-2.499c-.896.61-2.054.955-3.402.955-2.61 0-4.821-1.76-5.615-4.126H1.264v2.576A10.001 10.001 0 0 0 10.2 20Z"
        fill="#34A853"
      />
      <path
